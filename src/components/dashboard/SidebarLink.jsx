...
const SidebarLink = ({ to, icon, activeIcon, label, onClick }) => {
	if (to === "/logout") {
		return (
			<li onClick={onClick}>
				<div
					className={`group flex flex-start gap-4 text-lg items-center p-2 px-3 w-full rounded-md transition duration-300 ease-in-out hover:bg-secondaryHoverBlue hover:bg-opacity-50 hover:text-darkGray`}
				>
